...
public class ListViewUserCenterMyAnswersAdapter extends BaseAdapter {
	...
	public ListViewUserCenterMyAnswersAdapter(Context context,List<OnlineQuestion> data,int resource) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView==null){
			...
			listItemView.grade = (TextView) convertView.findViewById(R.id.usercentermyanswer_item_user_grade);
			listItemView.subject = (TextView) convertView.findViewById(R.id.usercentermyanswer_item_question_course);
			...
			listItemView.answerCount = (TextView) convertView.findViewById(R.id.usercentermyanswerlist_item_bottom_ans_now_txt_id);
